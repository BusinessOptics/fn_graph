...
setup(
    ...
    install_requires=['graphviz==0.*,>=0.13.2', 'joblib==0.*,>=0.14.1', 'littleutils==0.*,>=0.2.1', 'networkx==2.*,>=2.4.0'],
    extras_require={"dev": ["black==18.*,>=18.3.0.a0", "matplotlib==3.*,>=3.0.0", "mkdocs==1.*,>=1.0.0", "pandas==0.*,>=0.25.3", "plotly==4.*,>=4.0.0", "pytest==5.*,>=5.3.0", "recommonmark==0.*,>=0.6.0", "seaborn==0.*,>=0.10.0", "sklearn==0.*,>=0.0.0", "sphinx==2.*,>=2.2.0", "sphinx-rtd-theme==0.*,>=0.4.3", "statsmodels==0.*,>=0.11.1"]},
)
